    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            if(!empty($employee)){
            ?>
            <small> <?php echo "{$employee['last_name']}, {$employee['first_name']} {$employee['middle_name']}" ?> </small>
            <?php
            }
            ?>
          </h1>
            ...
            <div class='col-md-12'>
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li <?php echo empty($employee)?'class="disabled"':''; ?> <?php echo $tab=="15"?'class="active"':''?>><a href="?tab=15<?php echo !empty($employee)?"&id={$employee['id']}":''; ?>" <?php echo empty($employee)?'onclick="alert(\''.$no_employee_msg.'\');return false;"':''; ?>>On Boarding Check List</a>
                    </li>
                    <li <?php echo empty($employee)?'class="disabled"':''; ?> <?php echo $tab=="16"?'class="active"':''?>><a href="?tab=16<?php echo !empty($employee)?"&id={$employee['id']}":''; ?>" <?php echo empty($employee)?'onclick="alert(\''.$no_employee_msg.'\');return false;"':''; ?>>Off Boarding Check List</a>
                    </li>
                </ul>
                  ...
                  <div class="active tab-pane" >
                    <?php
                        switch ($tab) {
                            ...
                            case '15':
                                #off boarding
                                $form='on_boarding.php';
                                break;
                            case '16':
                                #off boarding
                                $form='off_boarding.php';
                                break;
                            default:
                                $form='personal_information.php';
                                break;
