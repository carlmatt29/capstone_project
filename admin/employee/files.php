        ...
        <?php foreach($data as $row): ?>
            <tr>
                ...
                <td class='text-center'>
                    ...
                    <?php 
                        $file=$con->myQuery("SELECT file_name,file_location FROM employees_files WHERE id=? AND is_deleted=0",array($row['id']))->fetch(PDO::FETCH_ASSOC); 
                    ?>
                    <a href="emp_files/<?php echo $file['file_location']; ?>" class='btn btn-default' title='View File' target="_blank"><span class='fa fa-search'></span></a>
