<?php
    ...
    $branch                = $con->myQuery("SELECT id as branch_id,branch_name FROM branch WHERE is_deleted=0")->fetchAll(PDO::FETCH_ASSOC);
...
<div id='collapseForm' class='collapse'>
    <form class='form-horizontal' action='save_employment_movement.php' method="POST" onsubmit="return confirm('Do you want to save the changes in employee information?')">
        ...
        <div class="form-group">
            <label for="ecola" class="col-md-3 control-label">ECOLA </label>
            <div class="col-md-7">
                <input type="text" class="form-control" id="ecola"  name='ecola' placeholder="00.00" value='<?php echo !empty($employee)?htmlspecialchars($employee['ecola']):''; ?>'>
            </div>
        </div>
