<?php
  ...
  if(!empty($_GET['date_end'])){
    $date_end=date_create($_GET['date_end']." 23:59:00");
  }
  else{
    $date_end="";
  }
  ...
  $(function () {
        ...
        $.fn.dataTable.ext.search.push(
          function( settings, data, dataIndex ) {
              ...
              var min = Date.parse( '<?php echo !empty($date_start)?date_format($date_start,"Y/m/d H:i:s"):'';?>' );
              var max = Date.parse( '<?php echo !empty($date_end)?date_format($date_end,"Y/m/d H:i:s"):'';?>' );
