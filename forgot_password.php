...
?>
    <div class="login-box">
      <div class="login-box-body" style="border-radius: 10px;border: #A5A0A4 1px solid;">
        ...
        <!-- <img src="dist/img/eigerlogo.png" class='img-responsive center-block' >-->
        </div><!-- /.login-logo -->
        <?php
          Alert();
        ?>
        <?php
          if($step==1):
        ?>
          <h4 class="login-box-msg text-yellow">Enter your username</h4>
        ...
        <?php
          elseif($step==2):
        ?>
          <h4 class="login-box-msg text-yellow">Enter the answer to the question</h4>
          <form action="forgot_password.php" method="post">
