...
<?php 
  $set = $con->myQuery("SELECT * FROM payroll_general_settings")->fetch(PDO::FETCH_ASSOC);
?>
        <!-- Logo -->
        <a href="index.php" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><img src='../dist/img/acrew_favicon.png' /></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Eiger</b> Payroll</span>
        </a>
