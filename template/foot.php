...
?>
    ...
    <script src="<?php echo str_repeat('../',$level) ?>plugins/datatables/extensions/dataTables.select.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        $('#basic_salary').inputmask("decimal",{
            radixPoint: ".",
            groupSeparator: ",",
            digits: 2,
            autoGroup: true,
        ...
        //sss number format
        //$(".sss").inputmask("99-9999999-99", {"placeholder": "##-#######-##"}); //no limitation david commented this april 4 2019
